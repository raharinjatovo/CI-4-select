  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form action="<?php echo site_url('CI/public/home/confpass'); ?>" method="post" >
          <div class="form-group has-feedback">
            <input id="country" type="password" name="password" <?php if(isset($password)){
          ...
          <div class="form-group has-feedback">
            <input type="password"  name="confirm" <?php if(isset($confirm)){
              echo 'class="form-control is-invalid"';
            }
            else {
              echo 'class="form-control"';
